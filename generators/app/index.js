...
var MyGenerator = (function (_Base) {
  ...
  function MyGenerator() {
    ...
    var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MyGenerator)).call.apply(_Object$getPrototypeO, [this].concat(args)));

    _this.package = {
      dependencies: [],
      devDependencies: []
    };
    _this.webpackEntry = ['lodash', 'angular', 'angular-animate', 'angular-sanitize', 'angular-ui-router', 'ionic', 'ionicAngular'];
    return _this;
  }
      ...
      return {
        appName: function appName() {
          ...
          var prompt = [{
            ...
            choices: ['restangular', 'js-data', 'none']
          }, {
            type: 'confirm',
            name: 'menu',
        ...
        menu: function menu() {
          if (this.options.menu) {
            ...
            this.options.menuHtml = '<ion-content>\n            <ion-list>\n              <ion-item ui-sref="home">\n                Home\n              </ion-item>\n            </ion-list>\n          </ion-content>';
          }
        },
